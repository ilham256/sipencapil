...
class CpmktlangModel extends Model
{
    protected $table = 'nilai_cpmk_tak_langsung'; // Default table
    ...
    public function getCpmkTLang($dataMataKuliah)
    {
        return $this->db->table('nilai_cpmk_tak_langsung')
                        ->select('*')
                        ->join('matakuliah_has_cpmk', 'matakuliah_has_cpmk.id_matakuliah_has_cpmk = nilai_cpmk_tak_langsung.id_matakuliah_has_cpmk')
