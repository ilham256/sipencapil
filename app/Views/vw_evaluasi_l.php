						...
						<div class="row mb-3">
							...
							<div class="col-sm-3">
								<select id="mk" class="form-select">
									...
									<option value="2017">TIN 237</option>
								</select>
							</div>
						</div>
					</form>
	...
	for (var i = 0; i < a; i++) {
		datai[i] = {
				...
				datasets: [{
					...
					data: [data_cpl_1[i], data_cpl_2[i], data_cpl_3[i], data_cpl_4[i], data_cpl_5[i], data_cpl_6[i], data_cpl_7[i], data_cpl_8[i]],
				}, {
					label: "Target",
					...
					data: [(data_target_cpl), (data_target_cpl), (data_target_cpl), (data_target_cpl), (data_target_cpl), (data_target_cpl), (data_target_cpl), (data_target_cpl)]
				}]
			}
