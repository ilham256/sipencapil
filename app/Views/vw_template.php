...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-maroon elevation-4">
    ...
    <a href="<?php echo site_url() ?>"  class="brand-link">
      ...
      <span class="brand-text font-weight-light">SiPenCapil</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?= base_url('akun') ?>" class="d-block">Administrator</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?php if (in_array($breadcrumbs, ['kurikulum','cpmk_cpl','matakuliah','profil_matakuliah','formula' ])) {echo "menu-open";}?>">
            <a href="#" class="nav-link <?php if (in_array($breadcrumbs, ['kurikulum','cpmk_cpl','matakuliah','profil_matakuliah','formula' ])) {echo "active";}?>">
          ...
          <li class="nav-item <?php if (in_array($breadcrumbs, ['katkin','cpmklang','cpmktlang','cpltlang','efektivitas_cpl','relevansi_ppm','epbm' ])) {echo "menu-open";}?>">
            <a href="#" class="nav-link <?php if (in_array($breadcrumbs, ['katkin','cpmklang','cpmktlang','cpltlang','efektivitas_cpl','relevansi_ppm','epbm' ])) {echo "active";}?>">
          ...
          <li class="nav-item <?php if (in_array($breadcrumbs, ['data', 'data_cpmk', 'data_persentase_nilai_masuk'])) {echo "menu-open";}?>">
            <a href="#" class="nav-link <?php if (in_array($breadcrumbs, ['data', 'data_cpmk', 'data_persentase_nilai_masuk'])) {echo "active";}?>">
