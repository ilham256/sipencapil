			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="card-header">
						<h3 class="card-title">Kinerja Capaian Pembelajaran Lulusan (CPL)</h3>
					...
					<!-- /.card-header -->
					<form method="post" action="<?php echo site_url('kinumum') ?>" enctype="multipart/form-data">
					<div class="card-body">
...
<script>
	...
	var cpl = <?php echo json_encode($list_cpl); ?>;
	var target = [];
