  ...
  <aside class="main-sidebar sidebar-dark-success elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?= base_url('akun') ?>" class="d-block">Lecturer</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?php if (in_array($breadcrumbs, ['infumum', 'kinumum', 'kincpmk', 'kincpl'])) {echo "menu-open";}?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url('dashboarddosen/infumum') ?>" class="nav-link <?php if ($breadcrumbs == 'infumum') {echo "active";}?>">
          ...
          <li class="nav-item has-treeview">
            <a href="<?= base_url('evaluasildosen') ?>" class="nav-link <?php if ($breadcrumbs == 'evaluasi_l') {echo "active";}?>">
          ...
          <li class="nav-item <?php if (in_array($breadcrumbs, ['report', 'report_epbm','report_kinerja_cpmk_mahasiswa','report_mahasiswa','report_mata_kuliah','report_relevansi_ppm','report_efektivitas_cpl'])) {echo "menu-open";}?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url('reportdosen') ?>" class="nav-link <?php if ($breadcrumbs == 'report') {echo "active";}?>">
                <i class="far fa-circle nav-icon"></i> 
                <p>Kinerja CPL Mahasiswa</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url('reportdosen/kinerja_cpmk_mahasiswa') ?>" class="nav-link <?php if ($breadcrumbs == 'report_kinerja_cpmk_mahasiswa') {echo "active";}?>">
                <i class="far fa-circle nav-icon"></i> 
                <p>Kinerja CPMK Mahasiswa</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url('reportdosen/mahasiswa') ?>" class="nav-link <?php if ($breadcrumbs == 'report_mahasiswa') {echo "active";}?>">
                <i class="far fa-circle nav-icon"></i> 
                <p>Report Mahasiswa</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url('reportdosen/mata_kuliah') ?>" class="nav-link <?php if ($breadcrumbs == 'report_mata_kuliah') {echo "active";}?>">
                <i class="far fa-circle nav-icon"></i> 
          ...
          <li class="nav-item has-treeview">
            <a href="<?= base_url('akundosen') ?>" class="nav-link <?php if (in_array($breadcrumbs, ['akun'])) {echo "active";}?>">
