	...
	<div class="card">
		<div class="card-body">
			...
			<ul class="nav nav-tabs" id="myTabs" role="tablist">
				...
				<li class="nav-item" role="presentation">
					<a href="<?php echo site_url('report_dosen/relevansi_ppm')?>" ><button class="nav-link active" id="cpl-tab" data-bs-toggle="tab" data-bs-target="#cpl" type="button" role="tab" aria-controls="cpl" aria-selected="true">Relevansi PPM</button></a>
				</li>
				<li class="nav-item" role="presentation">
