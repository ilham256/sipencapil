! function(r) {
    ...
    r(document).ready(function() {
        return e.radar("radar-chartjs-chart"), !1
    }), e = {
        bar: function(r, e, a) {
            var t = {
                ...
                n = document.getElementById(r).getContext("2d");
            return new Chart(n, {
                type: a,
                data: t,
                options: {
        ...
        line: function(r, e) {
            var a = {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: "rgba(245,112,122,0.3)",
                        data: [o(), o(), o(), o(), o(), o(), o(), o(), o(), o(), o()]
                    }]
                },
                t = document.getElementById(r).getContext("2d");
            return new Chart(t, {
                type: "line",
                data: a,
                options: {
        ...
        pie: function(r, e) {
            var a = document.getElementById(r).getContext("2d"),
                t = {
                    type: e,
                    data: {
                        datasets: [{
            ...
            return new Chart(a, t), !1
        },
        polar: function(r) {
            var e = document.getElementById(r).getContext("2d"),
                a = {
                    data: {
                        datasets: [{
                            data: [o(), o(), o(), o()],
            ...
            return new Chart.PolarArea(e, a), !1
        },
        radar: function(r) {
            var e = document.getElementById(r).getContext("2d"),
                a = {
